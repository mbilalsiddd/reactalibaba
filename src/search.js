...
return (
     <>
     <Chip label="Samsung" variant="outlined" />
     <Chip label="I Phone" variant="outlined" />
     <Chip label="Infinix" variant="outlined" />
     <Chip label="Tecno" variant="outlined" />
     <Chip label="Honda" variant="outlined" />
     <Chip label="Suzuki" variant="outlined" />
     <Chip label="Kawasaki" variant="outlined" />
     <Chip label="Super Power" variant="outlined" />
     <Chip label="Civic" variant="outlined" />
     <Chip label="Audi" variant="outlined" />
     <Chip label="Sport" variant="outlined" />
     <Chip label="Mercedes" variant="outlined" />
     <div>
